...
Properties of set algebra are similar to the [monotone laws](https://en.wikipedia.org/wiki/Boolean_algebra) in Boolean algebra. See also ![[Set Theory]]
...
#### b
**Q**: How many possibilities are there for Fred’s schedule of dinners for that Monday
...
**A**: $10\cdot9^4$ by the *multiplication principle*
### 23
...
Each of the 6 sequences has $3!=6$ combinations. For example 2,3,4 has the combinations:
2 3 4
2 4 3
3 2 4
3 4 2
...
Since we have 6 consecutive sequences with 6 combinations we have $6\cdot6=32$ sequences,
...
Such that there are $4+12=16$ possibilities. 
...
File explorer is on the bottom right pane in RStudio

Bottom pane is the console

Top left pane is the text editor

$\texttt{CTRL+Enter}$ to run

$\#$ for comments


## R packages
$\texttt{InvariantCausalPrediction}$
$\texttt{RMarkdown}$
$\texttt{}$